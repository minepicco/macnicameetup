    ...
    stages {
        ...
        stage('Scan') {
            steps {
                ...
                sh "/var/jenkins-home/twistcli images scan nginx -u admin -p Mimosa2008 --address https://35.221.72.157 --include-package-files --compliance-threshold critical --vulnerability-threshold high --details --upload --include-package-files"
            }
        }
        //stage('Publish') {
            //steps {
